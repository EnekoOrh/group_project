...
\hline
Case & Status & Selection basis & Task 6 run & Decision mode & Task 6 area (m\textasciicircum{}2) \\
\hline
...
The structural baseline keeps the same assumptions for every model: equivalent reinforced concrete with \texttt{E = 33 GPa}, \texttt{nu = 0.20}, and \texttt{rho = 2500 kg/m\textasciicircum{}3}, together with a constant shell thickness of \texttt{0.20 m}.

The reference wind speed is \texttt{30.0 m/s}, which gives a dynamic pressure of \texttt{562.5 Pa} through \texttt{q = 0.5 rho V\textasciicircum{}2}.
...
\chapter{4. Geometry Integrity Check}
...
\chapter{5. Refined Structural Comparison Across All 24 Cases}
...
\begin{tabular}{@{}llllll@{}}
\hline
Case & Status & Task 6 area (m\textasciicircum{}2) & Max disp. (mm) & Max stress (MPa) & Buckling factor \\
\hline
...
\chapter{6. Methodological Clarity and Global Ranking}


\section{6.1 Methodological Clarity}
...
Penalty points are \texttt{0} for engineering-feasible, \texttt{10} for mathematical fallback, and \texttt{20} for warning cases. The best model is the one with the lowest \texttt{J\_i}.


\section{6.2 Global Weighted Top-5}
...
\hline
Rank & Case & Status & Weighted score & Penalty & Buckling factor & Max disp. (mm) & Max stress (MPa) & Area (m\textasciicircum{}2) \\
\hline
...
\section{6.3 Top-3 by Criterion}


\subsection{6.3.1 Raw Top-3 (all statuses)}
...
\subsection{6.3.2 Engineering-eligible Top-3}
...
\chapter{7. Scenario-by-Scenario Comparison}
...
\hline
Algorithm & Status & Weighted score & Task 6 area (m\textasciicircum{}2) & Max disp. (mm) & Max stress (MPa) & Buckling factor \\
\hline
...
\chapter{12. Annex: Complete Field Visualizations}
