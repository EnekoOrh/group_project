...
![S1 / BFGS stress](results/figures/task7_s1_bfgs_stress.png) ![S1 / BFGS displacement](results/figures/task7_s1_bfgs_displacement.png) ![S1 / BFGS buckling](results/figures/task7_s1_bfgs_buckling_mode1.png)

#### S1 / PSO

![S1 / PSO stress](results/figures/task7_s1_pso_stress.png) ![S1 / PSO displacement](results/figures/task7_s1_pso_displacement.png) ![S1 / PSO buckling](results/figures/task7_s1_pso_buckling_mode1.png)

#### S1 / SA

![S1 / SA stress](results/figures/task7_s1_sa_stress.png) ![S1 / SA displacement](results/figures/task7_s1_sa_displacement.png) ![S1 / SA buckling](results/figures/task7_s1_sa_buckling_mode1.png)

### Scenario S2

#### S2 / PSO

![S2 / PSO stress](results/figures/task7_s2_pso_stress.png) ![S2 / PSO displacement](results/figures/task7_s2_pso_displacement.png) ![S2 / PSO buckling](results/figures/task7_s2_pso_buckling_mode1.png)

### Scenario S3

#### S3 / BFGS

![S3 / BFGS stress](results/figures/task7_s3_bfgs_stress.png) ![S3 / BFGS displacement](results/figures/task7_s3_bfgs_displacement.png) ![S3 / BFGS buckling](results/figures/task7_s3_bfgs_buckling_mode1.png)

### Scenario S4

#### S4 / BFGS

![S4 / BFGS stress](results/figures/task7_s4_bfgs_stress.png) ![S4 / BFGS displacement](results/figures/task7_s4_bfgs_displacement.png) ![S4 / BFGS buckling](results/figures/task7_s4_bfgs_buckling_mode1.png)

#### S4 / PSO

![S4 / PSO stress](results/figures/task7_s4_pso_stress.png) ![S4 / PSO displacement](results/figures/task7_s4_pso_displacement.png) ![S4 / PSO buckling](results/figures/task7_s4_pso_buckling_mode1.png)

#### S4 / SA

![S4 / SA stress](results/figures/task7_s4_sa_stress.png) ![S4 / SA displacement](results/figures/task7_s4_sa_displacement.png) ![S4 / SA buckling](results/figures/task7_s4_sa_buckling_mode1.png)

### Scenario S5

#### S5 / BFGS

![S5 / BFGS stress](results/figures/task7_s5_bfgs_stress.png) ![S5 / BFGS displacement](results/figures/task7_s5_bfgs_displacement.png) ![S5 / BFGS buckling](results/figures/task7_s5_bfgs_buckling_mode1.png)

#### S5 / PSO

![S5 / PSO stress](results/figures/task7_s5_pso_stress.png) ![S5 / PSO displacement](results/figures/task7_s5_pso_displacement.png) ![S5 / PSO buckling](results/figures/task7_s5_pso_buckling_mode1.png)

#### S5 / SA

![S5 / SA stress](results/figures/task7_s5_sa_stress.png) ![S5 / SA displacement](results/figures/task7_s5_sa_displacement.png) ![S5 / SA buckling](results/figures/task7_s5_sa_buckling_mode1.png)

### Scenario S6

#### S6 / BFGS

![S6 / BFGS stress](results/figures/task7_s6_bfgs_stress.png) ![S6 / BFGS displacement](results/figures/task7_s6_bfgs_displacement.png) ![S6 / BFGS buckling](results/figures/task7_s6_bfgs_buckling_mode1.png)

#### S6 / PSO

![S6 / PSO stress](results/figures/task7_s6_pso_stress.png) ![S6 / PSO displacement](results/figures/task7_s6_pso_displacement.png) ![S6 / PSO buckling](results/figures/task7_s6_pso_buckling_mode1.png)

#### S6 / SA

![S6 / SA stress](results/figures/task7_s6_sa_stress.png) ![S6 / SA displacement](results/figures/task7_s6_sa_displacement.png) ![S6 / SA buckling](results/figures/task7_s6_sa_buckling_mode1.png)

### Scenario S7

#### S7 / PSO

![S7 / PSO stress](results/figures/task7_s7_pso_stress.png) ![S7 / PSO displacement](results/figures/task7_s7_pso_displacement.png) ![S7 / PSO buckling](results/figures/task7_s7_pso_buckling_mode1.png)

#### S7 / SA

![S7 / SA stress](results/figures/task7_s7_sa_stress.png) ![S7 / SA displacement](results/figures/task7_s7_sa_displacement.png) ![S7 / SA buckling](results/figures/task7_s7_sa_buckling_mode1.png)

### Scenario S8

#### S8 / BFGS

![S8 / BFGS stress](results/figures/task7_s8_bfgs_stress.png) ![S8 / BFGS displacement](results/figures/task7_s8_bfgs_displacement.png) ![S8 / BFGS buckling](results/figures/task7_s8_bfgs_buckling_mode1.png)

#### S8 / PSO

![S8 / PSO stress](results/figures/task7_s8_pso_stress.png) ![S8 / PSO displacement](results/figures/task7_s8_pso_displacement.png) ![S8 / PSO buckling](results/figures/task7_s8_pso_buckling_mode1.png)

#### S8 / SA

![S8 / SA stress](results/figures/task7_s8_sa_stress.png) ![S8 / SA displacement](results/figures/task7_s8_sa_displacement.png) ![S8 / SA buckling](results/figures/task7_s8_sa_buckling_mode1.png)
